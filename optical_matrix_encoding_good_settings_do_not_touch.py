...
# Example usage
input_matrix = np.array([[0, 0, 1], [0, 0, 1], [1, 1, 1]])
macropixel_size = 70
grating_frequency_y = 0 # Frequency offset for y-axis



grating_frequency_x = 70
...
np.savetxt(r'C:\Users\jakub\Documents\code\python_code\matrix_gen\repo\slm_matrix_gen\formatted_matrices\saw_test_phase_pattern_70mp_70gf_trtl_test.csv', large_matrix, delimiter=',')
np.save(r'C:\Users\jakub\Documents\code\python_code\matrix_gen\repo\slm_matrix_gen\formatted_matrices\saw_test_phase_pattern_70mp_70gf_trtl_test.csv', large_matrix)
#np.savetxt(f'/repo/formatted_matrices/saw_test_phase_pattern_150mp_{grating_frequency_x}gf_centre.csv', large_matrix, delimiter=',')