...
for i in range(10):
    freq = 4*i
    phase_pattern_x = generate_phase_pattern(matrix, macropixel_size, freq)
    np.save(f'/Users/jakubkostial/Documents/phd/code/loop_matmul/repo/matrices/saw_test_phase_pattern_150mp_{freq}gf.npy', phase_pattern_x)
